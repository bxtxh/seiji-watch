...
test.describe("Issue Categories Navigation", () => {
  ...
  test("should navigate to categories page from main navigation", async ({
    page,
  }) => {
  ...
  test("should display breadcrumbs on category detail page", async ({
    page,
  }) => {
    await page.goto("/issues/categories");
    await page.waitForLoadState("networkidle");
  ...
  test("should navigate back to categories from detail page", async ({
    page,
  }) => {
    await page.goto("/issues/categories");
    await page.waitForLoadState("networkidle");
    ...
    await page
      .locator('nav[aria-label="Breadcrumb"] a[href="/issues/categories"]')
      .click();
    await page.waitForLoadState("networkidle");
  ...
  test("should handle category without children gracefully", async ({
    page,
  }) => {
    await page.goto("/issues/categories");
    await page.waitForLoadState("networkidle");
    ...
    const categoryWithoutChildren = page
      .locator('[data-testid="l1-category"]:not(:has(button))')
      .first();
