...
test.describe("PWA Features", () => {
  ...
  test("should work offline", async ({ page }) => {
    ...
    const offlineElements = await page
      .locator("text=/オフライン|offline/i")
      .count();
  ...
  test("should show appropriate PWA debug information in development", async ({
    page,
  }) => {
