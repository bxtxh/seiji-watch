...
test.describe('Search Functionality', () => {
  ...
  test('should enforce input length limits', async ({ page }) => {
    ...
    await expect(page.locator(TestHelpers.selectors.validationError)).toBeVisible();
  });
  ...
  test('should show loading state during search', async ({ page }) => {
    ...
    await expect(page.locator(TestHelpers.selectors.loadingIndicator)).toBeVisible();
    
    // Should show search results after loading
    await expect(page.locator(TestHelpers.selectors.searchResults)).toBeVisible({ timeout: 10000 });
  });
  ...
  test('should handle search errors gracefully', async ({ page }) => {
    ...
    await expect(page.locator(TestHelpers.selectors.errorMessage)).toContainText(/エラー|失敗/);
  });
  ...
  test('should be accessible', async ({ page }) => {
    ...
    await helpers.expectElementToBeAccessible(TestHelpers.selectors.searchInput);
    
    // Check search button accessibility
    await helpers.expectElementToBeAccessible(TestHelpers.selectors.searchButton);
