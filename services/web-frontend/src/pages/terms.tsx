        ...
        <div className="prose prose-lg max-w-none japanese-text">
          ...
          <section id="section-2" className="mb-8">
            ...
            <ul className="space-y-3">
              <li>
                <strong>データ</strong> —
                国会関連メタデータ、文字起こし、要約、メディアファイルその他本サービスが提供する情報資源。
              </li>
              <li>
                <strong>コード</strong> —
                本サービスを構成するプログラム、スクリプト、設定ファイル。
              </li>
            </ul>
          </section>
          ...
          <section id="section-3" className="mb-8">
            ...
            <ol className="space-y-3 list-decimal list-inside">
              <li>
                データは、Creative Commons Attribution 4.0 International（CC BY
                4.0）に従い、出典表示さえ行えば商用・非商用を問わず二次利用・改変・再配布を自由に行える。ただし、政府・国会その他公的機関が別途ライセンスを指定している場合は当該条件が優先する。
              </li>
              <li>コードは MIT ライセンスで公開する。</li>
              <li>
          ...
          <section id="section-9" className="mb-8">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p>
                Email:
                <a
                  href="mailto:contact@politwatch.jp"
                  className="text-primary-green hover:underline"
                >
