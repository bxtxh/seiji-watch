      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <nav className="bg-gray-50 rounded-lg p-6 mb-8" aria-labelledby="toc-heading">
          ...
          <ol className="space-y-2 text-sm">
            <li><a href="#section-1" className="text-primary-green hover:underline">1. 適用範囲</a></li>
            <li><a href="#section-2" className="text-primary-green hover:underline">2. 取得する情報</a></li>
            <li><a href="#section-3" className="text-primary-green hover:underline">3. 利用目的</a></li>
            <li><a href="#section-4" className="text-primary-green hover:underline">4. アクセス解析（Google Analytics 4）</a></li>
            <li><a href="#section-5" className="text-primary-green hover:underline">5. 第三者提供</a></li>
            <li><a href="#section-6" className="text-primary-green hover:underline">6. 管理体制・安全管理措置</a></li>
            <li><a href="#section-7" className="text-primary-green hover:underline">7. 利用者の権利</a></li>
            <li><a href="#section-8" className="text-primary-green hover:underline">8. プライバシーポリシーの変更</a></li>
            <li><a href="#section-9" className="text-primary-green hover:underline">9. お問い合わせ窓口</a></li>
          </ol>
        </nav>
        ...
        <div className="prose prose-lg max-w-none japanese-text">
          ...
          <section id="section-2" className="mb-8">
            ...
            <ol className="space-y-3 list-decimal list-inside">
              <li>
                <strong>アクセスログ</strong> — IP アドレス、ブラウザ種別、リファラー、閲覧日時等。
              </li>
              <li>
                <strong>Cookie 等</strong> — Google Analytics 4（以下「GA4」）が発行する Client ID など。氏名・メールアドレス等の直接識別子は含まない。
              </li>
              <li>
                <strong>お問い合わせメール</strong> — 利用者が当団体宛に送信するメール本文・送信元アドレス。
              </li>
            </ol>
          ...
          <section id="section-4" className="mb-8">
            ...
            <ol className="space-y-3 list-decimal list-inside">
              ...
              <li>
                GA4 では IP 匿名化(Anonymize IP) オプションを有効化しており、収集した IP アドレスの末尾は即時にマスクされる。
              </li>
              <li>
                収集データは Google LLC のプライバシーポリシーに基づき米国など国外サーバーへ転送・保管される場合がある。
              </li>
              <li>
          ...
          <section id="section-5" className="mb-8">
            ...
            <p className="mb-3">当団体は、以下の場合を除き利用者情報を第三者へ提供しない。</p>
            <ul className="space-y-2 list-disc list-inside">
              <li>法令に基づく開示要請がある場合</li>
              <li>人の生命・身体・財産の保護に必要で本人同意が困難な場合</li>
              <li>アクセス統計を個人を識別できない形に加工した上で公開または共有する場合</li>
            </ul>
          </section>
          ...
          <section id="section-6" className="mb-8">
            ...
            <ul className="space-y-2 list-disc list-inside">
              <li>通信は TLS で暗号化</li>
              <li>アクセスログは権限管理された環境に保管し、90 日経過後に自動削除</li>
              <li>個人情報データベースへのアクセスは最小権限・多要素認証を適用</li>
              <li>セキュリティ詳細（ファイアウォール設定等）は公開しませんが、適切な技術的・組織的対策を継続的に実施します。</li>
            </ul>
          </section>
          ...
          <section id="section-7" className="mb-8">
            ...
            <p className="mb-3">利用者は、個人情報保護法に基づき次の請求ができる。</p>
          ...
          <section id="section-9" className="mb-8">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p>
                Email: 
                <a href="mailto:privacy@politwatch.jp" className="text-primary-green hover:underline">
