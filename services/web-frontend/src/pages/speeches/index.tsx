          ...
          <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-lg p-6 md:p-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">トピック分析</h3>
                <p className="text-sm text-gray-600">
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">スマート検索</h3>
                <p className="text-sm text-gray-600">
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            ...
            <div className="space-y-3 text-sm text-gray-600">
              <div className="flex items-start space-x-3">
                ...
                <p><strong>キーワード検索:</strong> 検索ボックスに関心のあるキーワードを入力してください</p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-xs font-semibold">2</span>
                <p><strong>トピックフィルタ:</strong> 「トピックでフィルタ」を開いて関心のある分野を選択してください</p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-xs font-semibold">3</span>
                <p><strong>詳細確認:</strong> 検索結果でAI要約を確認し、「続きを読む」で全文を表示できます</p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-xs font-semibold">4</span>
                <p><strong>関連発言:</strong> トピックタグをクリックして関連する他の発言を探すことができます</p>
              </div>
            </div>
          </div>
