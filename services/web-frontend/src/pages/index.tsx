    ...
    <Layout>
      <div className="space-y-8">
        ...
        <div className="hero-section text-center py-8 sm:py-16 px-4 sm:px-8 mb-6 sm:mb-8 fade-in-up">
          ...
          <p className="mt-3 sm:mt-4 text-sm sm:text-base lg:text-lg text-gray-600 max-w-3xl mx-auto japanese-body animate-fade-in leading-relaxed" style={{animationDelay: '0.2s'}}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8 stagger-children">
          <div className="card-interactive text-center p-4 sm:p-6">
            ...
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">論点を抽出</h3>
          ...
          <div className="card-interactive text-center p-4 sm:p-6">
            ...
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">リアルタイム更新</h3>
            <p className="text-xs sm:text-sm text-gray-600 japanese-text leading-relaxed">
          ...
          <div className="card-interactive text-center p-4 sm:p-6 sm:col-span-2 lg:col-span-1">
            <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 bg-primary-green bg-opacity-10 rounded-lg flex items-center justify-center interactive-scale">
              <svg className="w-5 h-5 sm:w-6 sm:h-6 text-primary-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5-5-5h5v-5a7.5 7.5 0 00-15 0v5h5l-5 5-5-5h5v-5a9.5 9.5 0 0119 0v5z" />
              </svg>
            </div>
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">論点をウォッチ！</h3>
            <p className="text-xs sm:text-sm text-gray-600 japanese-text leading-relaxed">
        ...
        <div className="card bg-gray-50 border-gray-200 overflow-hidden p-4 sm:p-6">
          <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">使い方</h2>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg p-4 sm:p-6 max-w-md w-full mx-4 shadow-xl">
              <div className="flex items-center mb-3 sm:mb-4">
                <svg className="h-5 w-5 sm:h-6 sm:w-6 text-red-500 mr-2 sm:mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="text-base sm:text-lg font-semibold text-gray-900">システム通知</h3>
              </div>
