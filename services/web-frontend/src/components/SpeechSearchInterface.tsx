    ...
    <div className="space-y-6">
      ...
      <div className="card">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="speech-search" className="block text-sm font-medium text-gray-700 mb-2">
              発言を検索
            </label>
            ...
            {validationError ? (
              ...
              <p id="speech-search-help" className="mt-2 text-sm text-gray-600">
          ...
          <div className="flex items-center justify-between">
            ...
            >
              <svg className={`h-4 w-4 transition-transform ${showTopicFilter ? 'rotate-90' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {showTopicFilter && (
            <div className="border-t pt-4">
              <p className="text-sm font-medium text-gray-700 mb-3">トピックを選択</p>
      ...
      {results.length > 0 && (
        <div className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-900">発言検索結果</h2>
      ...
      {(query || selectedTopics.length > 0) && !loading && results.length === 0 && !error && (
        <div className="text-center py-12">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">該当する発言が見つかりませんでした</h3>
