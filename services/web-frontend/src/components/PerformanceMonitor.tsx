              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    ...
                    <div
                      className={`text-lg font-semibold px-2 py-1 rounded ${getPerformanceScore(metrics.loadTime, { good: 1000, poor: 2000 })}`}
                    >
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    ...
                    <div
                      className={`text-lg font-semibold px-2 py-1 rounded ${getPerformanceScore(metrics.domContentLoaded, { good: 800, poor: 1500 })}`}
                    >
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    ...
                    <div
                      className={`text-lg font-semibold px-2 py-1 rounded ${getPerformanceScore(metrics.firstContentfulPaint, { good: 1800, poor: 3000 })}`}
                    >
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    ...
                    <div
                      className={`text-lg font-semibold px-2 py-1 rounded ${getPerformanceScore(metrics.largestContentfulPaint, { good: 2500, poor: 4000 })}`}
                    >
                        ...
                        {metrics.networkRequests.length > 0 ? (
                          metrics.networkRequests.map((request, index) => (
                            <tr key={index} className="hover:bg-gray-50">
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <span
                                  className={`px-2 py-1 rounded ${getPerformanceScore(request.duration, { good: 500, poor: 1000 })}`}
                                >
              ...
              <div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <ul className="text-sm text-blue-800 space-y-2">
                    <li>
                      • 仮想スクロールにより、大量のデータも効率的に表示されます
                    </li>
                    <li>
                      • 日本語検索の最適化により、快適な検索体験を提供します
                    </li>
                    <li>
                      • メモリ使用量を監視し、必要に応じて最適化を行います
                    </li>
                    <li>
                      • APIレスポンス時間を監視し、パフォーマンスを向上させます
                    </li>
                  </ul>
                </div>
              </div>
