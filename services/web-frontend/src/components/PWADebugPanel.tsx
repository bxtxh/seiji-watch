...
export default function PWADebugPanel({ isOpen, onClose }: PWADebugPanelProps) {
  ...
  const [networkStatus, setNetworkStatus] = useState<{
    online: boolean;
    connection?: string;
  }>({ online: true, connection: "unknown" });
  const [swStatus, setSWStatus] = useState<string>("checking");
  const [installPromptAvailable, setInstallPromptAvailable] =
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <span
                  className={`ml-2 ${networkStatus.online ? "text-green-600" : "text-red-600"}`}
                >
              ...
              <div>
                ...
                <span
                  className={`ml-2 ${installPromptAvailable ? "text-green-600" : "text-gray-600"}`}
                >
