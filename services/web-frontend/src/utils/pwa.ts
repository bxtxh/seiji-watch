...
function showUpdateNotification(registration: ServiceWorkerRegistration) {
  ...
  notificationDiv.className = 'flex items-center justify-between p-4 bg-blue-50 border border-blue-200 rounded-lg mb-4';
  ...
  dismissBtn.className = 'text-blue-600 hover:text-blue-800 text-sm font-medium';
  dismissBtn.textContent = '後で';
  
  const applyBtn = document.createElement('button');
  applyBtn.id = 'pwa-update-apply';
  applyBtn.className = 'bg-blue-600 text-white px-3 py-1 rounded text-sm font-medium hover:bg-blue-700';
...
function showInstallButton(prompt: PWAInstallPrompt): void {
  ...
  installButton.className = 'fixed bottom-4 right-4 bg-green-600 text-white px-4 py-2 rounded-lg shadow-lg hover:bg-green-700 transition-colors z-50 flex items-center space-x-2';
