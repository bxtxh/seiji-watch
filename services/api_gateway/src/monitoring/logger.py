...
class StructuredLogger:
    ...
    def api_request(
        self, request: Request, response_status: int, response_time_ms: float, **kwargs
    ):
    ...
    def business_event(self, event_type: str, description: str, **kwargs):
        """Log business logic events."""
        entry = self._create_log_entry(
            "INFO", description, business_event_type=event_type, **kwargs
        )
        self.logger.info(json.dumps(entry))
...
def log_api_request(
    request: Request, response_status: int, response_time_ms: float, **kwargs
):
    """Log API request."""
