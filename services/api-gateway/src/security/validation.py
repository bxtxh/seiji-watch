...
class InputValidator:
    ...
    @classmethod
    def validate_pagination_params(cls, limit: int, offset: int) -> Tuple[bool, Optional[str]]:
    ...
    @classmethod
    def validate_certainty_threshold(cls, threshold: float) -> Tuple[bool, Optional[str]]:
    ...
    @classmethod
    def validate_request_body(cls, body: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
...
class SecurityValidator:
    ...
    @staticmethod
    def check_request_headers(headers: Dict[str, str]) -> Tuple[bool, Optional[str]]:
