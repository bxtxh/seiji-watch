...
class MemberService:
            ...
            for member_data in mock_members:
                try:
                    ...
                    if existing_member:
                        ...
                        updated_member = await self.airtable.update_member(
                            existing_member["id"], 
                            member_data
                        )
                        results["updated"] += 1
    ...
    async def get_member_with_cache(self, member_id: str, force_refresh: bool = False) -> Optional[Dict[str, Any]]:
    ...
    async def get_members_list(self, filters: Optional[Dict[str, Any]] = None, 
    ...
    def _build_airtable_filter(self, filters: Dict[str, Any]) -> Optional[str]:
    ...
    async def search_members(self, query: str, filters: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
