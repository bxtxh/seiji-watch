...
from shared.models.bill import Bill, BillStatus, BillCategory
...
class DataProcessor:
    ...
    async def process_bill_data(self, bill_data: BillData) -> Optional[str]:
        """
    ...
    async def _find_existing_bill(self, bill_number: str) -> Optional[Dict]:
    ...
    def get_processing_stats(self) -> Dict[str, Union[int, List[str]]]:
