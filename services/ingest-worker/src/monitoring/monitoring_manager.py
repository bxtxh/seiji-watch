...
from .monitoring_service import MonitoringService, AlertRule, AlertSeverity, AlertType, NotificationChannel
...
class MonitoringManager:
    ...
    def __init__(self, database_url: str, config: Optional[MonitoringConfiguration] = None):
