...
from .data_quality_auditor import DataQualityAuditor, QualityReport, QualityIssue
from .data_completion_processor import DataCompletionProcessor, CompletionTask, BatchCompletionResult
...
class MigrationReport:
    ...
    final_quality_report: Optional[QualityReport] = None
...
class DataMigrationService:
    ...
    def create_migration_plan(self, target_bills: Optional[List[str]] = None) -> MigrationPlan:
    ...
    def get_migration_status(self, execution_id: str) -> Optional[MigrationExecution]:
