...
from services.ingest_worker.src.migration.data_migration_service import DataMigrationService
from services.ingest_worker.src.migration.data_quality_auditor import DataQualityAuditor
from services.ingest_worker.src.migration.data_completion_processor import DataCompletionProcessor
...
def cmd_execute(args):
    ...
    try:
        ...
        if args.plan_file:
            ...
            from services.ingest_worker.src.migration.data_migration_service import MigrationPlan
            from services.ingest_worker.src.migration.data_completion_processor import CompletionTask, CompletionStrategy, CompletionPriority
