...
from .pdf_processor import PDFProcessor, PDFVoteRecord, PDFVotingSession
...
class EnhancedHRProcessor:
    ...
    async def _extract_pdf_metadata(self, pdf_url: str) -> dict[str, Any] | None:
