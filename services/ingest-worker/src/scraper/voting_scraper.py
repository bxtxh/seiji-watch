...
class VotingSession:
    ...
    vote_stage: Optional[str]  # 第一読会/第二読会/最終
...
class VotingScraper:
    ...
    def _parse_voting_table(self, table, vote_type: str, committee_name: Optional[str] = None) -> Optional[VotingSession]:
    ...
    def _parse_vote_record(self, cells) -> Optional[VoteRecord]:
