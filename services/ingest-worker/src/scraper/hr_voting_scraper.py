...
from .resilience import CacheConfig, RateLimitConfig, ResilientScraper
...
class HouseOfRepresentativesVotingScraper:
    ...
    def __init__(self, enable_resilience: bool = True):
        ...
        self._resilient_scraper: ResilientScraper | None = None
        if enable_resilience:
            self._init_resilient_scraper()

        # Cache for member names to improve PDF processing
        self._member_names_cache: list[str] | None = None
    ...
    async def _process_pdfs_with_resilience(
        ...
        try:
            ...
            async def process_single_pdf(pdf_url: str) -> PDFVotingSession | None:
