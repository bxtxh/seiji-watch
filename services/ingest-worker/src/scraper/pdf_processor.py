...
class PDFProcessor:
    ...
    async def _extract_text_with_ocr(self, pdf_content: bytes) -> str | None:
    ...
    def _extract_bill_information(self, text: str) -> dict[str, Any] | None:
