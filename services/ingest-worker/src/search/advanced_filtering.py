...
import json
import re
from sqlalchemy import create_engine, text, and_, or_, not_, func, case, desc, asc
...
class AdvancedFilterEngine:
    ...
    def __init__(self, database_url: str):
        ...
        self.text_fields = [
            'title', 'bill_outline', 'background_context', 'expected_effects', 'summary'
        ]
