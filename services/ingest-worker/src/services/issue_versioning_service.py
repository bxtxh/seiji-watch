...
class IssueVersionHistory:
    ...
    # Temporal fields
    valid_from: date
    valid_to: Optional[date] = None    # None means current version
...
class ConflictResolution:
    ...
    merge_result: Optional[Dict[str, Any]] = None  # Merged content if applicable
...
class IssueVersioningService:
    ...
    def __init__(self, airtable_manager: Optional[AirtableIssueManager] = None):
    ...
    async def create_new_version(self, issue_id: str, updated_record: AirtableIssueRecord,
        ...
        conflict_detected = await self._detect_version_conflicts(issue_id, updated_record)
    ...
    async def get_current_version(self, issue_id: str) -> Optional[IssueVersionHistory]:
    ...
    async def get_version_at_date(self, issue_id: str, target_date: date) -> Optional[IssueVersionHistory]:
    ...
    async def cleanup_old_versions(self, cutoff_date: Optional[date] = None) -> Dict[str, int]:
