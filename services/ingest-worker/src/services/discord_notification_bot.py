...
class DiscordNotificationBot:
    ...
    def __init__(self, config: Optional[DiscordNotificationConfig] = None):
    ...
    def _create_notification_message(self, pending_count: int, stats: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if pending_count == 0:
            ...
            emoji = "🚨"
            title = "レビュー緊急"
            description = f"レビュー待ちのイシューが **{pending_count}件** と多数あります。"
            color = 0xe74c3c  # Red
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        next_notification = self._calculate_next_notification_time() if self.is_running else None
