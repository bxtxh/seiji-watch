...
class DataQualityValidator:
    ...
    def validate_bills_data(self, bills: list[dict[str, Any]]) -> ValidationResult:
        ...
        metrics.append(
            QualityMetric(
                ...
                recommendations=self._get_title_quality_recommendations(
                    title_quality_score
                ),
            )
        )
        ...
        metrics.append(
            QualityMetric(
                ...
                recommendations=self._get_category_recommendations(
    ...
    def validate_voting_data(
        ...
        complete_sessions = sum(
            ...
            if self._is_voting_session_complete(session)
        )
        completeness_score = (
            complete_sessions / len(voting_sessions) if voting_sessions else 0
        )
        ...
        metrics.append(
            QualityMetric(
                ...
                recommendations=self._get_vote_consistency_recommendations(
                    consistency_score
                ),
            )
        )
        ...
        metrics.append(
            QualityMetric(
                ...
                recommendations=self._get_member_data_recommendations(
        ...
        metrics.append(
            QualityMetric(
                ...
                recommendations=self._get_party_diversity_recommendations(
                    party_diversity_score
                ),
            )
        )
    ...
    def validate_metadata(self, pilot_data: dict[str, Any]) -> ValidationResult:
        ...
        metrics.append(
            QualityMetric(
                ...
                recommendations=self._get_metadata_recommendations(
    ...
    def _get_performance_recommendations(
        self, score: float, duration: float
    ) -> list[str]:
