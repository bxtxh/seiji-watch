...
class VectorClient:
    ...
    def _ensure_schema_exists(self):
        ...
        try:
            ...
            if not bills_exists:
                bills_collection = self.weaviate_client.collections.create(
                    name="Bills",
            ...
            if not speeches_exists:
                speeches_collection = self.weaviate_client.collections.create(
                    name="Speeches",
    ...
    def store_bill_embedding(self, bill_data: Dict, embedding: EmbeddingResult) -> Optional[str]:
        """
    ...
    def store_speech_embedding(self, speech_data: Dict, embedding: EmbeddingResult) -> Optional[str]:
        """
