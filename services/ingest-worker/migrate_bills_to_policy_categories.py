...
class BillsPolicyCategoryMigrator:
    ...
    async def load_mapping_data(self):
        ...
        try:
            with open("bills_to_issue_categories_mapping_t129.json", 'r', encoding='utf-8') as f:
    ...
    async def create_policy_category_relationships(self, dry_run=True):
        ...
        print(f"   🚀 Creating relationships in batches...")
        created_count = 0
        failed_count = 0
    ...
    async def verify_migration(self):
        ...
        print(f"   📊 Relationships by source:")
    ...
    async def run_migration(self, dry_run=True):
        ...
        if dry_run:
            ...
            print(f"   python3 migrate_bills_to_policy_categories.py --execute")
