...
from services.policy_issue_extractor import PolicyIssueExtractor, BillData, DualLevelIssue
...
class TestCompleteExtractionWorkflow:
    ...
    async def test_error_recovery_workflow(self, mock_components):
        ...
        if not circuit_breaker:
            from monitoring.error_recovery_system import CircuitBreaker, CircuitBreakerConfig
