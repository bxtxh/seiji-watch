...
def create_test_data() -> list[BillRecord]:
    ...
    return [
        # 既存IDがある法案
        BillRecord("rec1", "HC001", "デジタル庁設置法案", "2025-01-24", "成立", "成立", "内閣", "デジタル", "217", "衆議院"),
        BillRecord("rec2", "SM001", "議員報酬改正法案", "2025-02-15", "審議中", "委員会", "田中議員", "制度", "217", "参議院"),

        # Bill_IDが欠損している法案
        BillRecord("rec3", "", "予算関連法案", "2025-03-01", "審議中", "委員会", "内閣", "予算", "217", "衆議院"),
        BillRecord("rec4", None, "地方創生推進法案", "2025-03-15", "審議中", "委員会", "山田議員", "地方", "217", "参議院"),
        BillRecord("rec5", "  ", "環境保護法案", "2025-04-01", "審議中", "委員会", "内閣", "環境", "217", ""),
        BillRecord("rec6", "", "条約批准案", "2025-04-15", "審議中", "委員会", "外務大臣", "条約", "217", "両院"),
        BillRecord("rec7", "", "承認案件", "2025-05-01", "審議中", "委員会", "内閣", "承認", "217", "衆議院"),
        BillRecord("rec8", "", "その他の法案", "2025-05-15", "審議中", "委員会", "佐藤議員", "その他", "217", "参議院"),
        BillRecord("rec9", "", "政府提出法案", "2025-06-01", "審議中", "委員会", "内閣", "制度", "217", ""),
        BillRecord("rec10", "", "無所属議員提出", "2025-06-15", "審議中", "委員会", "無所属議員", "制度", "217", "衆議院"),
    ]
    ...
    for description, bill, expected_pattern in test_cases:
        try:
            ...
            if actual_pattern == expected_pattern:
                ...
                print(f"❌ {description}: {generated_id} (期待: {expected_pattern}, 実際: {actual_pattern})")
