...
async def analyze_issue_categories():
    ...
    try:
        with open("bills_category_analysis_t129.json", 'r', encoding='utf-8') as f:
    ...
    async with aiohttp.ClientSession() as session:
        ...
        print(f"   📋 Sample IssueCategories record structure:")
        ...
        for bills_category, count in bills_categories.items():
            ...
            if exact_matches:
                ...
                if bills_category == "その他":
                    ...
                    print(f"   → Using fallback category for 'その他'")
        ...
        print(f"✅ T129.2 Analysis complete!")
        print(f"\n🎯 Next steps for T129.3:")
        print(f"   1. Review the mapping results")
        print(f"   2. Create Bills-PolicyCategory relationship records")
        print(f"   3. Verify the migration worked correctly")
...
async def create_fallback_mapping(bills_categories):
    ...
    print(f"✅ T129.2 Fallback analysis complete!")
