            ...
            if response.status == 200:
                ...
                for table in data.get("tables", []):
                    if table["name"] == "Issues (課題)":
                        ...
                        print(f"  Current Issues table fields:")
                ...
                fields_to_add = [
                    ...
                    {"name": "Category_L1", "type": "singleSelect", "options": {
                        "choices": [
                            {"name": "社会保障"}, {"name": "経済・産業"}, {"name": "外交・国際"},
                            {"name": "教育・文化"}, {"name": "環境・エネルギー"}, {"name": "司法・行政"},
                            {"name": "インフラ・交通"}
                        ]
                    }},
                    ...
                    {"name": "Status", "type": "singleSelect", "options": {
                        "choices": [
                            {"name": "active"}, {"name": "inactive"}, {"name": "resolved"}
                        ]
                    }},
                    ...
                    {"name": "AI_Confidence", "type": "number", "options": {"precision": 2}},
