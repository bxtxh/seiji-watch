...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_parties_created_at"), "parties", ["created_at"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_parties_updated_at"), "parties", ["updated_at"], unique=False
    )
    ...
    op.create_index(
        "idx_member_active_house", "members", ["is_active", "house"], unique=False
    )
    op.create_index(
        "idx_member_name_party", "members", ["name", "party_id"], unique=False
    )
    op.create_index(
        "idx_member_party_house", "members", ["party_id", "house"], unique=False
    )
    op.create_index(
        op.f("ix_members_created_at"), "members", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_members_diet_member_id"), "members", ["diet_member_id"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_members_is_active"), "members", ["is_active"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_members_updated_at"), "members", ["updated_at"], unique=False
    )
    ...
    op.create_index(
        "idx_bill_category_session", "bills", ["category", "diet_session"], unique=False
    )
    op.create_index(
        "idx_bill_content_embedding", "bills", ["content_embedding"], unique=False
    )
    op.create_index("idx_bill_search", "bills", ["title", "bill_number"], unique=False)
    op.create_index(
        "idx_bill_status_date", "bills", ["status", "submitted_date"], unique=False
    )
    op.create_index(
        "idx_bill_timeline",
        "bills",
        ["submitted_date", "final_vote_date"],
        unique=False,
    )
    op.create_index(
        "idx_bill_title_embedding", "bills", ["title_embedding"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_bills_diet_session"), "bills", ["diet_session"], unique=False
    )
    op.create_index(op.f("ix_bills_id"), "bills", ["id"], unique=False)
    op.create_index(op.f("ix_bills_status"), "bills", ["status"], unique=False)
    op.create_index(
        op.f("ix_bills_submitted_date"), "bills", ["submitted_date"], unique=False
    )
    ...
    op.create_index(
        "idx_meeting_committee",
        "meetings",
        ["committee_name", "meeting_date"],
        unique=False,
    )
    op.create_index(
        "idx_meeting_date_house", "meetings", ["meeting_date", "house"], unique=False
    )
    op.create_index(
        "idx_meeting_processing",
        "meetings",
        ["is_processed", "transcript_processed"],
        unique=False,
    )
    op.create_index(
        "idx_meeting_session_type",
        "meetings",
        ["diet_session", "meeting_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_meetings_committee_name"), "meetings", ["committee_name"], unique=False
    )
    op.create_index(
        op.f("ix_meetings_created_at"), "meetings", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_meetings_diet_session"), "meetings", ["diet_session"], unique=False
    )
    op.create_index(op.f("ix_meetings_house"), "meetings", ["house"], unique=False)
    op.create_index(op.f("ix_meetings_id"), "meetings", ["id"], unique=False)
    op.create_index(
        op.f("ix_meetings_is_processed"), "meetings", ["is_processed"], unique=False
    )
    op.create_index(
        op.f("ix_meetings_meeting_date"), "meetings", ["meeting_date"], unique=False
    )
    op.create_index(
        op.f("ix_meetings_meeting_id"), "meetings", ["meeting_id"], unique=True
    )
    op.create_index(
        op.f("ix_meetings_meeting_type"), "meetings", ["meeting_type"], unique=False
    )
    op.create_index(op.f("ix_meetings_title"), "meetings", ["title"], unique=False)
    op.create_index(
        op.f("ix_meetings_updated_at"), "meetings", ["updated_at"], unique=False
    )
    ...
    op.create_index(
        "idx_speech_bill_speaker",
        "speeches",
        ["related_bill_id", "speaker_id"],
        unique=False,
    )
    op.create_index(
        "idx_speech_content_embedding", "speeches", ["content_embedding"], unique=False
    )
    op.create_index(
        "idx_speech_meeting_order",
        "speeches",
        ["meeting_id", "speech_order"],
        unique=False,
    )
    op.create_index(
        "idx_speech_processing",
        "speeches",
        ["is_processed", "needs_review"],
        unique=False,
    )
    op.create_index(
        "idx_speech_speaker_date",
        "speeches",
        ["speaker_id", "start_time"],
        unique=False,
    )
    op.create_index(
        "idx_speech_type_date", "speeches", ["speech_type", "start_time"], unique=False
    )
    op.create_index(
        op.f("ix_speeches_created_at"), "speeches", ["created_at"], unique=False
    )
    op.create_index(op.f("ix_speeches_id"), "speeches", ["id"], unique=False)
    op.create_index(
        op.f("ix_speeches_is_processed"), "speeches", ["is_processed"], unique=False
    )
    op.create_index(
        op.f("ix_speeches_meeting_id"), "speeches", ["meeting_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_speeches_speaker_id"), "speeches", ["speaker_id"], unique=False
    )
    op.create_index(
        op.f("ix_speeches_speaker_type"), "speeches", ["speaker_type"], unique=False
    )
    op.create_index(
        op.f("ix_speeches_speech_order"), "speeches", ["speech_order"], unique=False
    )
    op.create_index(
        op.f("ix_speeches_speech_type"), "speeches", ["speech_type"], unique=False
    )
    op.create_index(
        op.f("ix_speeches_updated_at"), "speeches", ["updated_at"], unique=False
    )
    ...
    op.create_index(
        "idx_vote_bill_member", "votes", ["bill_id", "member_id"], unique=False
    )
    op.create_index(
        "idx_vote_bill_result", "votes", ["bill_id", "vote_result"], unique=False
    )
    op.create_index(
        "idx_vote_committee", "votes", ["committee_name", "vote_date"], unique=False
    )
    op.create_index(
        "idx_vote_date_house", "votes", ["vote_date", "house"], unique=False
    )
    op.create_index(
        "idx_vote_member_result", "votes", ["member_id", "vote_result"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_votes_vote_result"), "votes", ["vote_result"], unique=False
    )
