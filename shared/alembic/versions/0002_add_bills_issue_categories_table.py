...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_bills_categories_bill_id", "bills_issue_categories", ["bill_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "idx_bills_categories_manual", "bills_issue_categories", ["is_manual"]
    )

    # Composite indexes for common queries
    op.create_index(
        "idx_bills_categories_bill_confidence",
        "bills_issue_categories",
        ["bill_id", "confidence_score"],
    )
    op.create_index(
        "idx_bills_categories_airtable_confidence",
        "bills_issue_categories",
