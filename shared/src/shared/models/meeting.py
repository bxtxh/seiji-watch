...
class Meeting(BaseRecord):
    ...
    documents_urls: Optional[List[str]] = Field(
    ...
    def __repr__(self) -> str:
        return (
            ...
            f"title='{self.title[:50]}...', date='{self.meeting_date}')>"
        )
...
class Speech(BaseRecord):
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"<Speech(speaker='{speaker_name}', "
            f"order={self.speech_order}, meeting_id={self.meeting_id})>"
        )
