...
class Bill(BaseRecord):
    ...
    # Timeline
    submitted_date: str | None = Field(None, description="Submission date (YYYY-MM-DD)")
    ...
    committee_report_date: str | None = Field(None, description="Committee report date")
    ...
    # issue_category_relationships = relationship("BillsIssueCategories", back_populates="bill")
    ...
    def is_pending(self) -> bool:
        ...
        return self.status in [
            BillStatus.BACKLOG,
            BillStatus.UNDER_REVIEW,
            BillStatus.PENDING_VOTE,
        ]
