...
#### T20-1: ステージング環境構築・データ同期
**Priority:** P0 | **Estimate:** 12 hours
- [ ] ステージング環境構築（GCP Cloud Run + Cloud SQL + Cloud Storage）
- [ ] 本番データのステージング環境への手動同期（法案・議員・議事録）
- [ ] 3名のテストアカウント作成（ブラウザベースアクセス）
- [ ] 非技術者向け簡単ログイン設定（JWT tokens/メール認証）
- [ ] ステージング環境の動作確認・安定化
**DoD:** 3名が問題なくブラウザからアクセス可能なステージング環境

#### T20-2: 非技術者向けテストガイド作成
**Priority:** P0 | **Estimate:** 6 hours
- [ ] 簡潔なブラウザ操作ガイド（スクリーンショット付き）
- [ ] 4フェーズの具体的なテストシナリオ（チェックリスト形式）
- [ ] 問題報告用の簡易テンプレート（重要度・スクリーンショット）
- [ ] 連絡先・サポート情報
- [ ] よくある質問・トラブルシューティング
...
- [ ] **Phase 1 基本機能検証**: ログイン・ナビゲーション・基本操作（1日間）
- [ ] **Phase 2 実用シナリオ検証**: 法案検索・詳細閲覧・データ理解度（2日間）
- [ ] 3名全員による独立したテスト実施
- [ ] 簡易問題レポート収集（スクリーンショット・重要度設定）
- [ ] 日次進捗確認・質問対応・操作サポート
- [ ] データ正確性・情報の分かりやすさ評価
**DoD:** 3名が基本機能と主要シナリオを問題なく実行可能であることを確認

#### T20-4: Phase 3-4実施（ユーザビリティ・総合評価）
**Priority:** P0 | **Estimate:** 16 hours (2日間)
- [ ] **Phase 3 ユーザビリティ評価**: 使いやすさ・情報の見つけやすさ（1日間）
- [ ] **Phase 4 総合評価**: 全体的な使い勝手・改善提案（1日間）
- [ ] 非技術者視点での率直なフィードバック収集
- [ ] 実用性・継続利用意向の確認
- [ ] 本番利用に向けた承認・懸念事項の整理
- [ ] 改善提案・優先度の協議
**DoD:** 3名全員による本番利用承認と建設的な改善提案の獲得
